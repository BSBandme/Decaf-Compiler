...
class Method:
    ...
    def __init__(self, mname, mclass, visibility, storage, rtype):
        ...
        self.offset = 0
        self.rcode = []
        self.beginlabel = absmc.generate_new_label("%s_%d"%(self.name,self.id))
        self.endlabel = absmc.generate_new_label("%s_%d"%(self.name,self.id))
...
class IfStmt(Stmt):
    ...
    def codegen(self):
        ...
        self.stmt.codegen()
        self.rcode.extend(self.stmt.rcode)
...
class ReturnStmt(Stmt):
    ...
    def codegen(self):
        ...
        if(self.expr != None) :
            ...
            self.rcode.append(absmc.mv('a0',self.expr.t))
        self.rcode.append(absmc.ret())
...
class MethodInvocationExpr(Expr):
    ...
    def codegen(self):
        ...
        self.t = absmc.generate_new_temporary()
        self.rcode.append(absmc.mv(self.t, "a0"))
